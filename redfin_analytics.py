...
job_flow_overrides = {
    ...
    "LogUri": "s3://sundar28/emr-logs-yml/",
    ...
    "Instances": {
        ...
        "Ec2SubnetId": "subnet-06f6bbf382e211853", # Change
        "Ec2KeyName" : 'sundar28',
...
SPARK_STEPS_TRANSFORMATION = [
    {
        ...
        "HadoopJarStep": {
            ...
            "Args": ["spark-submit",
            "s3://sundar28/scripts/transform_redfin_data.py",
            ],
        },
    },
   ]   
